...
# WARNING: Ensure imports from `troyrc_ota` comes after this line
from troyrc_ota import app, settings, db  # noqa
from troyrc_ota.cli import create_user, cli  # noqa
